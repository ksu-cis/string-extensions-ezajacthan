...
namespace StringExtensions
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Capitializing");
            Console.WriteLine();
            ...
            Console.WriteLine("Decapitializing");
            Console.WriteLine();
            ...
            Console.WriteLine("Titlizing");
            Console.WriteLine();
            Console.WriteLine(writings[3].Titlize());
            Console.WriteLine(writings[4].Titlize());
        }
    }
}
